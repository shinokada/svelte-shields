<script lang="ts">
  ...
  let srcData = $state(`https://img.shields.io/npm/v/${packageName}${tagOpt}?${styleOpt}${logoOpt}${logoColorOpt}${logoSizeOpt}${labelOpt}${labelColorOpt}${color}${colorOpt}${cacheSecondsOpt}${link1}${link2}`)
</script>
