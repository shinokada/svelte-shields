<script lang="ts">
  ...
  let srcData = $state(`https://img.shields.io/jsr/v/${encodeURIComponent(scope)}/${packageName}?${styleOpt}${logoOpt}${logoColorOpt}${logoSizeOpt}${labelOpt}${labelColorOpt}${colorOpt}${cacheSecondsOpt}${link1}${link2}`)
